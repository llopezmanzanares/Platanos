...
balten_m3 |>
  ...
  geom_point(data = transform(balten_m3, mes = NULL), color = "grey85") +
  # geom_line(data = transform(balten_m3, mes = NULL), color = "grey85") +
  geom_point(color = "#7777DD") +
  geom_line(color = "#7777DD") +
  facet_wrap(vars(mes)) +
  labs(
    title = "Distribución del consumo de agua (m3 x bimestre)",
    x = NULL, y = NULL, color = NULL
  ) +
...
balten_m3 |>
  ...
  labs(
    title = "Acumulado anual del consumo de agua (m3)",
